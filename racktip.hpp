...
std::vector<int> gpios_right = {0, 0, 0, 1};
std::vector<int> gpios_left = {0, 0, 0, 0};
...
int HEIGHT=160;
int WIDTH=128;
int MOVE_DELAY=100000;
int DROP_DELAY=100000;
int STEPS=1;
int TOTAL_STEPS=160;
int PLATES_X_BEGIN=0;
int PLATES_Y_BEGIN=-123;
int PLATE_Y_MOVE=6;
int DROPPER_X_BEGIN=10;
...
int ARROWS_X_BEGIN=95;
int ARROWS_Y_BEGIN=115;
